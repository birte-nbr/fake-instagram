...
const UserController = {
  ...
  register: async (req, res) =>{
      try {
        ...
        let randomInteger1 = Math.floor(Math.random() * 2);
        let randomInteger2 = Math.floor(Math.random() * 2);
        let randomProfile = randomInteger1 + 1;
        let randomBackground = randomInteger2 + 1;          
        const profile_pic = randomProfile;
        const background_pic = randomBackground;
